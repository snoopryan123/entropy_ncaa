...
for (fold_ in 1:num_folds_parralelization_) {
  df_fold = read_csv(paste0(output_folder,"plot_grid_wpMaxScore_v",version_,"_fold",fold_,".csv"))
  GRID = bind_rows(GRID, df_fold)
}
write_csv(GRID, paste0(output_folder,"plot_grid_wpMaxScore_v",version_,".csv"))
